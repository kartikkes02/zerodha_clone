    ...
    return ( 
        <div className='container mt-5'>
            <div className='row text-center'>
                ...
                <h2 className='mb-5'>Now, we are breaking ground with our technology.</h2>
                <br></br> <br></br>
            </div>    
            ...
            <div className='row mt-5 text-muted'>
                ...
                <div className='col-4'>
                    ...
                    <p>Today, our disruptive pricing models and in-house technology have made us the biggest stock broker in India.Over 1.6+ crore clients place billions of orders every year through our powerful ecosystem of investment platforms, contributing over 15% of all Indian retail trading volumes.</p>
